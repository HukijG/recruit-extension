...
// Custom dropdown — Select (value-bound) and Menu (action-triggering).
// Verbatim from the extension; injected stylesheet stays self-contained.
...
function useDropdown<T extends string>(
  ...
  // Tparam not used directly, but generic enables consumers to pass a strict
  // value type to the dropdown wrapper. eslint complains otherwise; void it.
