...
// Settings popover — universal access to consultantFirstName + extension
// secret. Identical UX to the extension's settings-popover.tsx; only the
// underlying storage backing differs (browser localStorage in the PWA, the
// equivalent Plasmo storage in the extension), and that lives outside this
// file.
