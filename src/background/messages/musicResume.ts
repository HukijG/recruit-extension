...
const ROUTE_PATH = "/music/resume"

// Resume transport control. Sibling of musicPause — same envelope: one POST,
// secret as the X-Extension-Token header only, fire-and-forget (truth comes
// from the now-playing WS stream).
